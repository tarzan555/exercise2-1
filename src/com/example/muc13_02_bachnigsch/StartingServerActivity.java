 ...
 * 
 *         This Activity starts a BluetoothServer and waits for incoming
 *         Client-requests
 * 
 */
public class StartingServerActivity extends Activity {
	...
	/**
	 * method gets called after user interacted with "foreign" activity
	 * 
	 * checks for appropriate user actions
	 */
	@Override
