			...
			if (BluetoothDevice.ACTION_FOUND.equals(action)) {
				...
				if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1) {
					...
					for(ParcelUuid puuid : puuids) {
						if(puuid.getUuid() == UUID.fromString("4080ad8d-8ba2-4846-8803-a3206a8975be")) {
							Toast toast = Toast.makeText(getApplicationContext(), "Found MUCubigame on "+device.getName(), Toast.LENGTH_LONG);
							toast.show();
						}
					}
