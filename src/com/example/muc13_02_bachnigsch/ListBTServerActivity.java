...
public class ListBTServerActivity extends Activity {
	...
	/**
	 * BroadcastReceiver handling Bluetooth-Broadcasts: ACTION_FOUND: adds
	 * devices to list of discovered devices ACTION_DISCOVERY_FINISHED: starts
	 * fetching of UUIDs ACTION_UUID: compares UUIDs to GameUUID
	 */
