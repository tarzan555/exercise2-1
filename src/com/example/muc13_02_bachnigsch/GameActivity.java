...
public class GameActivity extends Activity {
	...
	/**
	 * @deprecated method was used for debugging purposes
	 * 
	...
	public void gestureTest(View view) {
		...
		textView2.setText("Geste: "
				+ gestureHandler.getPerformedGestures(
	...
	public void startGame(View view) {
		...
		while (true) {
			...
			if (currentRole == PlayerRole.RECEIVER) {
				...
				performedGestureNames = gestureHandler.getPerformedGestures(
						System.currentTimeMillis(), 5000);
	...
	/**
	 * this method gets called as soon as a gesture was received via BT should
	 * only be called when currentRole is PERFORMER
	 * 
	 * @param gesture
	 * @param timestamp
	 */
	public void onGestureReceived(int gesture, long timestamp) {
		if (currentRole == PlayerRole.PERFORMER) {
			...
			performedGestureNames = gestureHandler.getPerformedGestures(
					timestamp, timeFrame-50*(roundNumber-1));		// decrement timefram each round by 50ms
	...
	/**
	 * this method gets called as soon as a result was received via BT should
	 * only be called if currentRole is RECEIVER
	 * 
	 * @param win
	 *            is true in case of win, false in case of loss
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!mVibrator.hasVibrator()) {
			Toast toast = Toast.makeText(getApplicationContext(),
					"Device not able to vibrate!", Toast.LENGTH_LONG);
			toast.show();
		}
